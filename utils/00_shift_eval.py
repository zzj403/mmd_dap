...
iou_dir = '../common_data/NES_attack/YOLO3/iou20'
iou_list = os.listdir(iou_dir)

success_list = os.listdir('../common_data/NES_attack/YOLO3/success20')
fail = 0
iou_fail = 0
for iou_file in iou_list:
    ...
    with open(record_path,"r") as f:
        ...
        if not name in success_list:
            iou_fail += min_max_iou_old
            
       
        
print(iou_fail/len(iou_list))
print(fail)
