...
class PatchTrainer(object):
    ...
    def train(self):
        ...
        for i_batch, batch_data in enumerate(dataloader_obj):
            ...
            if img_name == '000000527096_453095.png':
                resume_flag = 1
            ...
            for enlarge_i in range(50):
                ...
                for t_op_step in range(t_op_num):
                    ...
                    if iou_max < 0.05 or torch.max(multi_lvl_conf_scores_batch) < 0.45:
                        ...
                        # save image
                        txt_save_dir =  '../common_data/NES_attack/disappear/YOLO3/area'
                        ...
                        out_file_path = os.path.join('../common_data/NES_attack/disappear/YOLO3/img', img_name)
